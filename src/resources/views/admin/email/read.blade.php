...
<!-- Init js-->
<script src="{{asset('backend/js/pages/email-read.init.js')}}"></script>
@endpush
@section('content')
<div class="content">
                    ...
                    <div class="inbox-rightbar">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="media mb-4 mt-1">
                                <img class="d-flex mr-3 rounded-circle avatar-sm" src="{{asset('backend/images/users/avatar-2.jpg')}}" alt="Generic placeholder image">
                                <div class="media-body">
                                    <span class="float-right">07:23 AM</span>
                                    <h5 class="m-0">Jonathan Smith</h5>
                            ...
                            <p>Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat
                                ...
                                sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar,</p>
                        ...
                        <div class="media mb-0 mt-5">
                            <img class="d-flex mr-3 rounded-circle avatar-sm"
                                src="{{asset('backend/images/users/avatar-7.jpg')}}" alt="Generic placeholder image">
                            <div class="media-body">
                        ...
                        <div class="text-right">
                            <button type="button"
                                class="btn btn-primary btn-rounded waves-effect waves-light width-md">Send</button>
                        </div>
