                    ...
                    <div class="inbox-leftbar">
                        ...
                        <div class="list-group b-0 mail-list mt-4">
                            <a href="#" class="list-group-item border-0"><span
                                    class="fa fa-circle text-info mr-2"></span>Web App</a>
                            <a href="#" class="list-group-item border-0"><span
                                    class="fa fa-circle text-warning mr-2"></span>Recharge</a>
                            <a href="#" class="list-group-item border-0"><span
                                    class="fa fa-circle text-purple mr-2"></span>Wallet Balance</a>
                            <a href="#" class="list-group-item border-0"><span
                                    class="fa fa-circle text-pink mr-2"></span>Friends</a>
                            <a href="#" class="list-group-item border-0"><span
                                    class="fa fa-circle text-success mr-2"></span>Family</a>
                        </div>
                        ...
                        <div class="" role="toolbar">
                            ...
                            <div class="btn-group mr-1">
                                <button type="button"
                                    class="btn btn-sm btn-light dropdown-toggle waves-effect"
                                    data-toggle="dropdown" aria-expanded="false">
                                    <i class="mdi mdi-dots-horizontal font-18 align-middle mr-1"></i> More
                                    <i class="mdi mdi-chevron-down"></i>
                                </button>
                                <div class="dropdown-menu">
                                    ...
                                    <ul class="message-list">
                                        <li class="unread">
                                            <div class="col-mail col-mail-1">
                                                ...
                                                <a href="#" class="title">Lucas Kriebel (via
                                                    Twitter)</a><span
                                                    class="star-toggle far fa-star"></span>
                                            </div>
                                            <div class="col-mail col-mail-2">
                                                <a href="#" class="subject">Lucas Kriebel (@LucasKriebel)
                                                    has sent
                                        ...
                                        <li>
                                            ...
                                            <div class="col-mail col-mail-2">
                                                <a href="#" class="subject">Mochila Beta: Subscription
                                                    Confirmed
                                                    &nbsp;–&nbsp; <span class="teaser">You've been
                                        ...
                                        <li>
                                            ...
                                            <div class="col-mail col-mail-2">
                                                <a href="#" class="subject">Task assigned: Clone ARP's
                                                    website
                                                    &nbsp;–&nbsp; <span class="teaser">You have been
                                        ...
                                        <li>
                                            ...
                                            <div class="col-mail col-mail-2">
                                                <a href="#" class="subject">1 new items in your
                                                    Stackexchange inbox
                                                    &nbsp;–&nbsp; <span class="teaser">The following items
                                                        were added to your Stack Exchange global inbox since
                                        ...
                                        <li>
                                            ...
                                            <div class="col-mail col-mail-2">
                                                <a href="#" class="subject">You can now use your storage in
                                                    Google
                                                    Drive &nbsp;–&nbsp; <span class="teaser">Hey Nicklas
                                                        Sandell! Thank you for purchasing extra storage
