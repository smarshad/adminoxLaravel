    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6 text-center">
                <div class="card-box" dir="ltr">
                    <div class="text-center">
                        <h5 class="font-weight-normal text-muted">Income Amounts</h5>
            ...
            <div class="col-lg-3 col-sm-6 text-center">
                <div class="card-box" dir="ltr">
                    <div class="text-center">
                        <h5 class="font-weight-normal text-muted">Total visits</h5>
            ...
            <div class="col-lg-3 col-sm-6 text-center">
                <div class="card-box" dir="ltr">
                    <div class="text-center">
                        ...
                        <h3 class="mb-3"><i class="mdi mdi-arrow-down-bold-hexagon-outline text-danger"></i> 545 <small>USD</small></h3>
                    </div>
                    <input data-plugin="knob" data-width="150" data-height="150" data-min="-100"
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6 text-center">
                <div class="card-box" dir="ltr">
                    <div class="text-center">
                        <h5 class="font-weight-normal text-muted">Lifetime Sales</h5>
                        <h3 class="mb-3"><i class="mdi mdi-arrow-down-bold-hexagon-outline text-danger"></i> 898 <small>USD</small></h3>
                    </div>
            ...
            <div class="col-lg-3 col-sm-6 text-center">
                <div class="card-box" dir="ltr">
                    ...
                    <input data-plugin="knob" data-width="150" data-height="150"
                        ...
                        data-cursor=true data-thickness=".2" data-angleOffset=-125
                        data-angleArc=250 value="44" />
                    <h6 class="text-muted mt-2">Angle offset and arc</h6>
                </div>
            </div><!-- end col-->
