...
@push('styles')
<link href="{{asset('backend/libs/tablesaw/tablesaw.css')}}" rel="stylesheet" type="text/css" />
@endpush
@push('scripts')
<!-- Tablesaw js -->
<script src="{{asset('backend/libs/tablesaw/tablesaw.js')}}"></script>
<!-- Init js -->
<script src="{{asset('backend/js/pages/tablesaw.init.js')}}"></script>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <h4 class="header-title"><b>Stack Table</b></h4>
                    <p class="sub-header">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <h4 class="header-title"><b>Sortable Table</b></h4>
                    <p class="sub-header">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <h4 class="header-title"><b>Swipe Table</b></h4>
                    <p class="sub-header">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <h4 class="header-title"><b>Swipe Table with Mini Map</b></h4>
                    <p class="sub-header">
                        Your awesome text goes here.
                    </p>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <h4 class="header-title"><b>Column Toggle Table</b></h4>
                    <p class="sub-header">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <h4 class="header-title"><b>Column Toggle Table with Mini Map</b></h4>
                    <p class="sub-header">
                        The Column Toggle Table allows the user to select which columns they want to be visible.
                    </p>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <h4 class="header-title"><b>Mode Switch Table</b></h4>
                    <p class="sub-header">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <h4 class="header-title"><b>Bare Table</b></h4>
                    <p class="sub-header">
                        Your awesome text goes here.
                    </p>
