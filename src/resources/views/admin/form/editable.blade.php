...
@push('styles')
<link href="{{asset('backend/libs/x-editable/bootstrap-editable.css')}}" rel="stylesheet" type="text/css" />
@endpush
@push('scripts')
<!-- Plugins js -->
<script src="{{asset('backend//libs/moment/moment.min.js')}}"></script>
<script src="{{asset('backend//libs/x-editable/bootstrap-editable.min.js')}}"></script>
...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h4 class="header-title mb-3">Inline Examples</h4>
