...
<script src="{{asset('backend/libs/jquery-mockjax/jquery.mockjax.min.js')}}"></script>
<script src="{{asset('backend/libs/autocomplete/jquery.autocomplete.min.js')}}"></script>
...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card-box">
                    ...
                    <label class="mb-1 mt-3 text-muted">Multiple Select</label>
                    <p class="sub-header">
                        Select2 can take a regular select box like this...
                    </p>
            ...
            <div class="col-lg-6">
                ...
                <form class="card-box">
                    ...
                    <div class="">
                        <label class="mb-1 mt-3 text-muted">Ajax Lookup</label>
                        <p class="sub-header">
                    ...
                    <div class="">
                        <label class="mb-1 mt-3 text-muted">Local Lookup and Grouping</label>
                        <p class="sub-header">
                            Your awesome text goes here
                        </p>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card-box">
                    ...
                    <label class="mb-1 mt-3 text-muted">Input Tags</label>
                    <p class="sub-header">
                    ...
                    <label class="mb-1 mt-3 text-muted">True multi value</label>
                    <p class="sub-header">
            ...
            <div class="col-lg-6">
                <div class="card-box">
                    ...
                    <label class="mb-1 mt-3 text-muted">Basic</label>
                    <p class="sub-header">
                    ...
                    <label class="mb-1 mt-3 text-muted">Sizes & Secondary color</label>
            ...
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="">
                                <label class="mb-1 mt-3 text-muted">Default usage</label>
                                <p class="sub-header">
                                ...
                                <div class="">
                                    <label class="mb-1 mt-3 text-muted">Threshold value</label>
                                    <p class="sub-header">
                                ...
                                <div class="">
                                    <label class="mb-1 mt-3 text-muted">All the options</label>
                                    <p class="sub-header">
                        ...
                        <div class="col-lg-6">
                            <div class="">
                                <label class="mb-1 mt-3 text-muted">Position</label>
                                <p class="sub-header">
                                ...
                                <div class="">
                                    <label class="mb-1 mt-3 text-muted">textareas</label>
                                    <p class="sub-header">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    <h4 class="header-title"><b>Bootstrap TouchSpin</b></h4>
                    <p class="sub-header">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="">
                                <form>
                                    <div>
                                        <label class="mb-1 text-muted">Using data attributes</label>
                                    ...
                                    <div>
                                        <label class="mb-1 mt-3 text-muted">Example with postfix (large)</label>
                                        <input id="demo1" type="text" value="55" name="demo1">
                                    </div>
                                    <div>
                                        <label class="mb-1 mt-3 text-muted">With prefix</label>
                        ...
                        <div class="col-lg-6">
                            <div class="mt-3 mt-lg-0">
                                <form>
                                    <div>
                                        <label class="mb-1 text-muted">Init with empty value:</label>
                                        <input id="demo3" type="text" value="" name="demo3">
                                    </div>
                                    <div>
                                        <label class="mb-1 mt-3 text-muted">Value attribute is not set (applying settings.initval)</label>
                                        <input id="demo3_21" type="text" value="" name="demo3_21">
                                    </div>
                                    <div>
                                        <label class="mb-1 mt-3 text-muted">Value is set explicitly to 33 (skipping settings.initval)</label>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <p class="sub-header">The jQuery plugin that brings select elements into the 21st century with intuitive multiselection, searching, and much more. Now with Bootstrap 4 support.</p>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="demo-box">
                                ...
                                <select class="selectpicker mb-0" multiple data-max-options="2" data-style="btn-pink">
                                    <option>Mustard</option>
                                    <option>Ketchup</option>
                                    <option>Relish</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="demo-box mt-4 mt-md-0">
                                <p class="text-muted">
                                    You can limit the number of elements you are allowed to select via the
                                    <code>
                                        data-max-option
                                ...
                                <select class="selectpicker" data-style="btn-secondary">
                                    <option data-icon="mdi mdi-account-circle mr-1">Mustard</option>
                                    <option data-icon="mdi mdi-airplane mr-1">Ketchup</option>
                                    <option data-icon="mdi mdi-airplay mr-1">Relish</option>
                                    <option data-icon="mdi mdi-adjust mr-1">Mayonnaise</option>
                                    <option data-icon="mdi mdi-apple mr-1">Barbecue Sauce</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="demo-box mt-4 mt-md-0">
                                ...
                                <select class="selectpicker" multiple data-selected-text-format="count" data-style="btn-secondary">
                                    <option>Mustard</option>
                                    <option>Ketchup</option>
                                    <option>Relish</option>
                                </select>
                                ...
                                <br />
                                <br />
                                <select class="selectpicker" multiple data-selected-text-format="count > 3" data-style="btn-secondary">
                                    <option>Mustard</option>
                                    <option>Ketchup</option>
                                    <option>Relish</option>
