...
@push('styles')
<link href="{{asset('backend/libs/nestable2/jquery.nestable.min.css')}}" rel="stylesheet" type="text/css" />
@endpush
@push('scripts')
<!-- Plugins js-->
...
<!-- Nestable init-->
<script src="{{asset('backend/js/pages/nestable.init.js')}}"></script>
@endpush
@section('content')
<div class="content">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Nestable Lists</li>
                        </ol>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="text-left" id="nestable_list_menu">
                    <button type="button" class="btn btn-pink waves-effect waves-light mr-1"
