...
@push('scripts')
<!-- rating js -->
<script src="{{asset('backend/libs/ratings/jquery.raty-fa.js')}}"></script>

<!-- Init js -->
<script src="{{asset('backend/js/pages/rating.init.js')}}"></script>
@endpush
@section('content')
<div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="mt-4 mt-lg-0">
                                    ...
                                    <p class="sub-header">
                                        If you need to start you score depending of a dynamic value, you can
                                        to
                                        use callback for it.
                                        You can pass any value for it, not necessarily a data- value. You
                                        can
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-4">
                                <div class="mt-4">
                                    ...
                                    <p class="sub-header">
                                        You can receive the number of stars dynamic using callback to set
                                        it.
                                    </p>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-4">
                                <div class="mt-4">
                                    ...
                                    <p class="sub-header">
                                        You can prevent users to vote. It can be applied with or without
                                        score
                                        and all stars will receives the hint corresponding of the selected
                                        star.
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-4">
                                <div class="mt-4">
                                    ...
                                    <p class="sub-header">
                                        If readOnly is enabled and there is no score, the hint "Not rated
                                        yet!"
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-4">
                                <div class="mt-4">
                                    ...
                                    <p class="sub-header">
                                        We changed the default interval [x.25 .. x.76], now x.26 will round
                                        down instead of to be a half star.
                                        Remember that the full attribute is used only when halfShow is
                                        disabled.
                                    </p>
                            ...
                            <div class="col-lg-4">
                                <div class="mt-4">
                                    ...
                                    <p class="sub-header">
                                        Enables the half star mouseover to be possible vote with half
                                        values.
                                    </p>
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-4">
                                <div class="mt-4">
                                    ...
                                    <p class="sub-header">
                                        Add a cancel button on the left side of the stars to cacel the
                                        score.
                            ...
                            <div class="col-lg-4">
                                <div class="mt-4">
                                    ...
                                    <p class="sub-header">
                                        Like the stars, the cancel button have a hint too, and you can
                                        change it.
                                    </p>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-4">
                                <div class="mt-4">
                                    ...
                                    <p class="sub-header">
                                        ...
                                        The range attribute is until wich position the icon will be
                                        displayed.
                                    </p>
                            ...
                            <div class="col-lg-4">
                                <div class="mt-4">
                                    ...
                                    <p class="sub-header">
                                        The size of the icons are controlled by the css property font-size
                                        as
                                        all icons are text. The plugin tries to calculate the font size
                                        automatically, but should that fail, you can provide a size (in
                                        pixels)
                        ...
                        <div class="row mt-3">
                                ...
                                <div class="mt-4">
                                    ...
                                    <p class="sub-header">
                                        You have the option hint or score to chosse. <b id="targetType-hint"
                                            class="badge badge-success ml-1"></b>
                                    </p>
                            ...
                            <div class="col-lg-4">
                                <div class="mt-4">
                                    ...
                                    <p class="sub-header">
                                        You can choose a template to be merged with your hints and displayed
                                        on target.
                                    </p>
