    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-3">
                ...
                <!-- Simple card -->
                <div class="card">
                    <img class="card-img-top img-fluid" src="{{asset('backend/images/small/img-1.jpg')}}" alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="card">
                    <img class="card-img-top img-fluid" src="{{asset('backend/images/small/img-2.jpg')}}" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make
                            up the bulk of the card's content.</p>
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="card">
                    <img class="card-img-top img-fluid" src="{{asset('backend/images/small/img-3.jpg')}}" alt="Card image cap">
                    <div class="card-body">
                        <p class="card-text">Some quick example text to build on the card title and make
                            up the bulk of the card's content.</p>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card">
                    <img class="card-img-top img-fluid" src="{{asset('backend/images/small/img-5.jpg')}}" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <img class="card-img-bottom img-fluid" src="{{asset('backend/images/small/img-7.jpg')}}" alt="Card image cap">
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card bg-dark">
                    <div class="card-body">
                        ...
                        <p class="card-text text-white-50">With supporting text below as a natural lead-in to
                            additional content.</p>
                        <a href="#" class="btn btn-primary waves-effect waves-light">Button</a>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12">
                <h4 class="mt-2 mb-3 font-18">Card Group</h4>
        ...
        <div class="row">
            <div class="col-12">
                <h5 class="mt-4 mb-3 font-18">Decks</h5>
                <div class="card-deck-wrapper">
                    <div class="card-deck">
                        <div class="card">
                            <img class="card-img-top img-fluid" src="{{asset('backend/images/small/img-4.jpg')}}" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
                        ...
                        <div class="card">
                            <img class="card-img-top img-fluid" src="{{asset('backend/images/small/img-6.jpg')}}" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
        ...
        <div class="row">
            <div class="col-12">
                <h5 class="mt-4 mb-3 font-18">Navigation</h5>
        ...
        <div class="row">
            <div class="col-12">
                <h5 class="mt-2 mb-3 font-18">Columns</h5>
                <div class="card-columns">
                    <div class="card">
                        <img class="card-img-top img-fluid" src="{{asset('backend/images/small/img-7.jpg')}}" alt="Card image cap">
                        <div class="card-body">
                    ...
                    <div class="card">
                        <img class="card-img img-fluid" src="{{asset('backend/images/small/img-2.jpg')}}" alt="Card image cap">
                    </div>
                    <div class="card card-body">
                        <blockquote class="card-bodyquote mb-0">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere
