...
<div class="content">
    ...
    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="nav flex-column nav-pills tabs-vertical" role="tablist" aria-orientation="vertical">
                                    ...
                                    <a class="nav-link mb-1" id="v-messages-tab" data-toggle="pill" href="#v-messages" role="tab" aria-controls="v-messages" aria-selected="false">
                                        <span class="d-inline-block">Messages</span>
                                    </a>
                                    <a class="nav-link mb-1" id="v-settings-tab" data-toggle="pill" href="#v-settings" role="tab" aria-controls="v-settings" aria-selected="false">
                ...
                <div class="card-box">
                    ...
                    <div class="tabs-vertical-env">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <div class="tab-content pt-0">
                                    <div class="tab-pane fade show active" id="v2-home" role="tabpanel" aria-labelledby="v2-home-tab">
                                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim.</p>
                                        <p class="mb-0">Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt.Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim.</p>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="v2-messages" role="tabpanel" aria-labelledby="v2-messages-tab">
                                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim.</p>
                                        <p class="mb-0">Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt.Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim.</p>
                                    </div>
                            ...
                            <div class="col-sm-3">
                                <div class="nav flex-column nav-pills tabs-vertical" role="tablist" aria-orientation="vertical">
                                    <a class="nav-link mb-1 active" id="v2-home-tab" data-toggle="pill" href="#v2-home" role="tab" aria-controls="v2-home" aria-selected="true">
                                        <span class="d-inline-block">Home</span>
                                    </a>
                                    <a class="nav-link mb-1" id="v2-profile-tab" data-toggle="pill" href="#v2-profile" role="tab" aria-controls="v2-profile" aria-selected="false">
                                        <span class="d-inline-block">Profile</span>
                                    </a>
                                    <a class="nav-link mb-1" id="v2-messages-tab" data-toggle="pill" href="#v2-messages" role="tab" aria-controls="v2-messages" aria-selected="false">
                                        <span class="d-inline-block">Messages</span>
                                    </a>
                                    <a class="nav-link mb-1" id="v2-settings-tab" data-toggle="pill" href="#v2-settings" role="tab" aria-controls="v2-settings" aria-selected="false">
                                        <span class="d-inline-block">Settings</span>
                                    </a>
                                </div>
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <p>
                    <a class="btn btn-primary mr-1" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                        Link with href
                    </a>
