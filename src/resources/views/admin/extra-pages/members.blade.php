        ...
        <div class="row">
                ...
                <div class="text-center card-box">
                    ...
                    <div class="member-card">
                        <div class="avatar-xl member-thumb mx-auto">
                            <img src="{{asset('backend/images/users/avatar-3.jpg')}}" class="rounded-circle img-thumbnail" alt="profile-image">
                        ...
                        <button type="button" class="btn btn-outline-primary mt-3 btn-rounded btn-bordered waves-effect width-md waves-light">Follow</button>
                ...
                <div class="text-center card-box">
                    ...
                    <div class="member-card">
                        <div class="avatar-xl member-thumb mb-2 mx-auto">
                            <img src="{{asset('backend/images/users/avatar-5.jpg')}}" class="rounded-circle img-thumbnail" alt="profile-image">
                            <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="text-center card-box">
                    ...
                    <div class="member-card">
                        <div class="avatar-xl member-thumb mb-2 mx-auto">
                            <img src="{{(asset('backend/images/users/avatar-2.jpg')}}" class="rounded-circle img-thumbnail" alt="profile-image">
                            <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="text-center card-box">
                    ...
                    <div class="member-card">
                        <div class="avatar-xl member-thumb mb-2 mx-auto">
                            <img src="{{asset('backend/images/users/avatar-6.jpg')}}" class="rounded-circle img-thumbnail" alt="profile-image">
                            <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="text-center card-box">
                    ...
                    <div class="member-card">
                        <div class="avatar-xl member-thumb mb-2 mx-auto">
                            <img src="{{asset('backend/images/users/avatar-7.jpg')}}" class="rounded-circle img-thumbnail" alt="profile-image">
                            <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="text-center card-box">
                    ...
                    <div class="member-card">
                        <div class="avatar-xl member-thumb mb-2 mx-auto">
                            <img src="{{asset('backend/images/users/avatar-8.jpg')}}" class="rounded-circle img-thumbnail" alt="profile-image">
                            <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="text-center card-box">
                    ...
                    <div class="member-card">
                        <div class="avatar-xl member-thumb mb-2 mx-auto">
                            <img src="{{asset('backend/images/users/avatar-9.jpg')}}" class="rounded-circle img-thumbnail" alt="profile-image">
                            <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="text-center card-box">
                    ...
                    <div class="member-card">
                        <div class="avatar-xl member-thumb mb-2 mx-auto">
                            <img src="{{asset('backend/images/users/avatar-10.jpg')}}" class="rounded-circle img-thumbnail" alt="profile-image">
                            <i class="mdi mdi-star-circle member-star text-success" title="verified user"></i>
                        </div>
